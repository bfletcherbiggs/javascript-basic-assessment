...
function makeChatMessage(str,signer){
	return obj = {
		message: str,
		author: signer,
		timestamp: new Date()
...
callerBack("Give it", function(holla) {
	return holla;
})
